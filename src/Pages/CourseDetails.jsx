...
import { formattedDate } from "../utils/form"
...
function CourseDetails() {
  ...
  const { courseId } = useParams()
   console.log(`course id from course details page se line 29: ${courseId}`)
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        setResponse(res)
        console.log("Printing response from line 41" , response);
      } catch (error) {
  ...
  useEffect(() => {
    const count = GetAvgRating(response?.data?.courseDetails.Rating)
  ...
  console.log("consoling response?.courseDetails" , response?.courseDetails)
  const {
    _id: course_id,
    CourseName,
    CourseDescription,
          ...
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <div className="text-md flex flex-wrap items-center gap-2">
                ...
                <span>{`${response?.numberOfStudentsEnrolled} students enrolled`}</span>
              </div>
              <div>
                <p className="">
