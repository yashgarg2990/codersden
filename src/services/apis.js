...
export const profileEndpoints = {
  GET_USER_DETAILS_API: BASE_URL + "/profile/get-your-details",
...
export const courseEndpoints = {
  GET_ALL_COURSE_API: BASE_URL + "/course/show-allcourses",
...
export const settingsEndpoints = {
  UPDATE_DISPLAY_PICTURE_API: BASE_URL + "/profile/update-display-image",
